...
import { NotificationItem } from "@/components/faculty/notifications/notification-item";
...
type LoadState =
  ...
  | { status: "ready"; notifications: FacultyNotification[]; unreadCount: number };
      ...
      {state.status === "ready" && state.notifications.length === 0 && (
        <Card>
          <CardContent className="flex flex-col items-center gap-2 py-10 text-center text-muted-foreground">
            ...
            <p className="text-sm">
              Evaluation assignments, review decisions, and mentorship updates will show up here.
            </p>
          </CardContent>
        </Card>
      )}
