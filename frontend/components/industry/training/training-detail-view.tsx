  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button size="sm" variant="outline" render={<Link href={`/industry/training/${training.id}/applicants`} />}>
            Applicants
          </Button>
          <Button size="sm" variant="outline" render={<Link href={`/industry/training/${training.id}/workspace`} />}>
            Workspace
          </Button>
          {canEdit ? (
