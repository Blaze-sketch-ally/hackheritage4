...
import { NotificationItem } from "@/components/industry/notifications/notification-item";
import { ApiError } from "@/lib/api";
import {
  listNotifications,
  markAllNotificationsRead,
  markNotificationRead,
} from "@/lib/industry/notifications";
import type { IndustryNotification } from "@/types/industry-notification";
...
type LoadState =
  ...
  | { status: "ready"; notifications: IndustryNotification[]; unreadCount: number };
      ...
      {state.status === "ready" && state.notifications.length === 0 && (
        <Card>
          <CardContent className="flex flex-col items-center gap-2 py-10 text-center text-muted-foreground">
            ...
            <p className="text-sm">
              New applications and applicant activity for your postings will show up here.
            </p>
          </CardContent>
        </Card>
      )}
