...
import { Bell, FolderKanban, GraduationCap, Presentation, UserPlus, UserMinus } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import { Button } from "@/components/ui/button";
import { CheckCircle2 } from "lucide-react";
import { cn } from "@/lib/utils";
import { relatedHref } from "@/types/industry-notification";
import type { IndustryNotification, RelatedEntityType } from "@/types/industry-notification";

const ENTITY_ICON: Record<RelatedEntityType, LucideIcon> = {
  INTERNSHIP_APPLICATION: UserPlus,
  JOB_APPLICATION: UserPlus,
  PROJECT_APPLICATION: FolderKanban,
  WORKSHOP_APPLICATION: Presentation,
  TRAINING_APPLICATION: GraduationCap,
};
...
export function NotificationItem({
  ...
  notification: IndustryNotification;
  ...
  const Icon =
    notification.type === "WITHDRAWAL"
      ? UserMinus
      : (notification.related_entity_type && ENTITY_ICON[notification.related_entity_type]) ||
        Bell;
