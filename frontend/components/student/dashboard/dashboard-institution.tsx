...
/**
 * Small "My Institution" summary card for the Student Dashboard. Derives
 * its state from the SAME two existing sources the full My Institution
 * page and InstitutionLinkCard already use -- student_profiles.
