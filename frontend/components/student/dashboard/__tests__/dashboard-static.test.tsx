...
// Strings that appeared in the deleted mock data -- none may ever resurface.
...
describe("DashboardRecommendations (real preview)", () => {
...
describe("DashboardAnnouncements (real events preview)", () => {
  afterEach(() => vi.resetAllMocks());
