 ...
 * (GET /api/v1/student/events, built over published `industry_workshops`).
 * Shows a few real upcoming events and links to /student/events. Only
 * actual event records are rendered -- no fabricated cards, no invented
 * registration state. Self-contained error handling.
 */
