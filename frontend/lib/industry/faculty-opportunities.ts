...
export function listFacultyOpportunityEngagements(): Promise<FacultyEngagementListResponse> {
  return api.get("/api/v1/industry/faculty-opportunities/engagements");
}
...
export function updateEngagementStatus(
  ...
  return api.patch(`/api/v1/industry/faculty-opportunities/engagements/${engagementId}/status`, {
    status: targetStatus,
  });
}
