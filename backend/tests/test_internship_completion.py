...
def test_required_skills_are_not_a_separate_completion_gate():
    ...
    signal anywhere in the schema -- 062's own docs say an internship
    ...
    program_assignments.is_required (060), exactly as sections 4 and 6 of
...
def test_module_items_never_gate_completion():
    # module_items has no is_required column in the schema (060) -- content
