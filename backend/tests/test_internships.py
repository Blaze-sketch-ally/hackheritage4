...
# NOTE: the source branch's test_internships.py also bundled two tests for
# GET /api/v1/skills (a skills-catalog browsing endpoint) here. That
# router/service was never adopted as part of this integration pass (out
# of scope -- app.api.skills/app.services.skill_service remain the
# pre-existing stub on this branch), so those two tests were removed
# rather than left permanently failing against a router this branch
# doesn't have.
