...
def test_no_historical_migration_was_modified_by_j1():
    ...
    for anchor, marker in (
        ...
        ("049_internship_program.sql", "create table if not exists internship_programs"),
        ("050_internship_workspace.sql", "create table if not exists internship_workspaces"),
        ("051_workspace_submissions_completion.sql", "create table if not exists workspace_submissions"),
    ):
