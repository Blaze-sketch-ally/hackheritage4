...
def build_anon_client() -> Client:
    ...
    `anon` (e.g. public.verify_internship_certificate,
    062_workspace_submissions_completion.sql) -- never for an ordinary
    user-scoped read, and never a substitute for
