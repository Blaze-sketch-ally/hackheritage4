...
(database/migrations/030_industry_workshops.sql). There is no `events`
...
(030_industry_workshops.sql explicitly has "no application/registration
...
# database/migrations/030_industry_workshops.sql -- industry_workshops.work_mode CHECK.
