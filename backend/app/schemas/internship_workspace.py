...
acceptance surface (database/migrations/061_internship_workspace.sql).
...
(061_internship_workspace.sql) is the real access-control boundary.
"""
...
# database/migrations/061_internship_workspace.sql -- CHECK value lists
...
# database/migrations/060_internship_program.sql -- module_items.item_type
...
class CreateSubmissionRequest(BaseModel):
    ...
    workspace_submissions supports (migration 062); which are required
