...
`student_notifications` (database/migrations/059_student_notifications.sql)
...
def emit_application_status_change(
    *,
    ...
    # notification write (RLS, network, migration 059 not yet applied, ...)
    # must not propagate.
...
# is an internal industry step (no notification). Migration 062 widened the
