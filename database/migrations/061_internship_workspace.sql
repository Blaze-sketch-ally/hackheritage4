-- Migration: 061_internship_workspace
...
-- 038_internship_workspace). Already applied to the live Supabase project
-- (confirmed: internship_workspaces exists live with real data).
--
...
create table if not exists internship_workspaces (
  ...
  -- 1:1 with the internship (060) and derived via internship_id wherever
...
-- workspace_submissions and is added in 062.
...
-- ============================================================
-- 4. Student-read policies for the 060 program-content tables
-- ============================================================
-- Deferred from 060 because they depend on internship_workspaces (via
