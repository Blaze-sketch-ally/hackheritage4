-- Migration: 060_internship_program
-- Adopted from a collaborator branch during the cross-branch integration
-- pass, renumbered to fit this repo's sequence (originally
-- 037_internship_program). Already applied to the live Supabase project
-- (confirmed: internship_programs/program_modules/module_items/
-- program_assignments exist live with real data).
--
...
-- is REMOTE/HYBRID, migration 061 provisions ONE internship_workspace per
...
-- internship_workspaces existing, so they are added by 061 (documented
-- again there). Submissions / completion / certificate / stipend are 062.
--
-- ============================================================
...
-- the student-read policies added in 061) route ownership through this one
-- function.
--
...
-- forward migration (exactly as 062 widens student_notifications).
...
-- No DELETE policy -- unpublish the module instead (see 062 edge cases).
...
--
--   -- Student-read policies for THESE tables are added by 061, once
