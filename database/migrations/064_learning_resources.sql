-- Migration: 064_learning_resources
...
-- 033_learning_resources). Already applied to the live Supabase project
-- (confirmed: learning_resources/learning_resource_skills/
-- student_learning_progress exist live with real data). The recommended-
-- resources feature this migration enables (Phase 6D, see its own header
-- below) is wired in this integration pass to THIS repo's own
-- career_roles-based skill-gap engine, not the source branch's retired
-- job_roles/skill_gap_service concept -- see
