-- Migration: 059_student_notifications
...
-- 035_student_notifications). Already applied to the live Supabase
-- project (confirmed: student_notifications exists live with real rows).
--
