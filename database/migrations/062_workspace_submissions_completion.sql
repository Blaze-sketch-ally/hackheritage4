-- Migration: 062_workspace_submissions_completion
...
-- 039_workspace_submissions_completion). Already applied to the live
-- Supabase project (confirmed: workspace_submissions/submission_reviews/
-- internship_completions/internship_certificates/stipend_disbursements
-- all exist live with real data).
--
...
-- * public.student_owns_workspace / public.industry_owns_workspace (061)
...
-- The 059 inline CHECKs are auto-named by Postgres; the DO blocks resolve
...
--   -- (059 ships the table empty; any later rows use the original values,
