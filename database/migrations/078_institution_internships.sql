-- Migration: 078_institution_internships
...
-- 074_institution_internship_visibility.sql) with an EXPLICIT
...
--     exactly what it has meant since 069_institution_tenancy.sql: an
...
--     institution_industry_partners (075_institution_industry_partners.sql)
