-- Migration: 041_institution_placement_drives
...
-- meant since 037_institution_tenancy.sql: an application row with
-- status = 'SELECTED'.
--
...
-- institution_visible_opportunity_titles (039_institution_student_directory.sql):
