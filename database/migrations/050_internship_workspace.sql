-- Migration: 050_internship_workspace
...
create table if not exists internship_workspaces (
  ...
  -- 1:1 with the internship (049) and derived via internship_id wherever
...
-- workspace_submissions and is added in 051.
...
-- ============================================================
-- 4. Student-read policies for the 049 program-content tables
-- ============================================================
-- Deferred from 049 because they depend on internship_workspaces (via
