-- Migration: 049_internship_program
...
-- is REMOTE/HYBRID, migration 050 provisions ONE internship_workspace per
...
-- internship_workspaces existing, so they are added by 050 (documented
-- again there). Submissions / completion / certificate / stipend are 051.
--
-- ============================================================
...
-- the student-read policies added in 050) route ownership through this one
-- function.
--
...
-- forward migration (exactly as 051 widens student_notifications).
...
-- No DELETE policy -- unpublish the module instead (see 051 edge cases).
...
--
--   -- Student-read policies for THESE tables are added by 050, once
